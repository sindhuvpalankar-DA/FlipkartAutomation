...
- End-to-end automation of Flipkart workflow:
  ...
  - Product page navigation and add-to-cart
- Screenshot capture after every key step
- Dynamic waits and popup handling
- Test execution with **TestNG**
- Continuous Integration setup using **Jenkins**
- Build management with **Maven**
- Scalable **Page Object Model (POM)** structure
...
| Reporting | TestNG Reports, Screenshots |
